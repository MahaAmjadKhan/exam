...
public class Responder
{
    ...
    {
        int count = 0;
        ArrayList<String> wordRepeat = new ArrayList<>();
        for(String word : words){
            System.out.println(responseMap.get(word));
            if(count < 5 && !wordRepeat.contains(word)){
                if(responseMap.containsKey(word)){
                    wordRepeat.add(word);
                    //String selectedResponse = word;
                    count++;
                    System.out.println(responseMap.get(word));
                ...
                count = 0;
                wordRepeat.removeAll(wordRepeat);
